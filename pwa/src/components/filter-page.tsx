...
export const FilterPage = (props: { children: React.ReactNode, tags: AsyncState<string[]>, open: boolean, selected: Maybe<string> , onToggleTray: () => void}) => (
    ...
    <section className={[styles.tray, props.open ? styles.open : styles.closed].join(' ')} >
      <div className={styles.trayContent} >
        ...
        <UncacheableContent<string[]> state={props.tags} >
          { isLoaded(props.tags) && <TagList tags={props.tags.value} selected={props.selected} /> }
        </UncacheableContent>
      </div>
